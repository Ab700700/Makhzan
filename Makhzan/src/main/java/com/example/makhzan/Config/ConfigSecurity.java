...
public class ConfigSecurity {
    ...
    public SecurityFilterChain securityFilterChain (HttpSecurity http) throws Exception{
        http.csrf().disable()
                ...
                .requestMatchers("/api/v1/makhzan/customer/register","/api/v1/makhzan/landlord/register","/api/v1/makhzan/user/login","/api/v1/makhzan/storage/search/*/**", "/api/v1/makhzan/storage/search-storage-name/*/*/**", "/api/v1/makhzan/storage/search-storage-landlord-name/*/*/**").permitAll()
