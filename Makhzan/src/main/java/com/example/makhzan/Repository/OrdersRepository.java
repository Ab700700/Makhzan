...
public interface OrdersRepository extends JpaRepository<Orders,Integer> {
    ...
    @Query("select o from  Orders o where  o.startDate>=?1 and o.endDate<=?2")
    List<Orders> getOrdersBetween(LocalDate localDate1, LocalDate localDate);
    ...
    List<Orders> findOrdersCompleted();
